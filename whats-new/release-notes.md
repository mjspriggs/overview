...
:   Configure, deploy, and monitor deployments by using DevOps best practices with projects. With projects, you can manage Infrastructure as Code at scale and ensure that its configuration is always valid, secure, and compliant. Learn more about [projects](/docs/secure-enterprise?topic=secure-enterprise-understanding-projects).
